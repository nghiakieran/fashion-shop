      ...
      <div>
        {
          cartData.map(item => {
            ...
            return (
              <div key={item._id} className='py-4 border-t border-b text-gray-700 grid 
      ...
      <div className='flex justify-end my-20'>
        <div className='w-full sm:w-[450px]'>
          ...
          <div className='w-full text-end'>
            <button onClick={() => navigate('/place-order')} className='bg-black text-white px-8 py-3 text-sm my-8'>PROCEED TO CHECKOUT</button>
          </div>
        </div>
      </div>
    </div>
